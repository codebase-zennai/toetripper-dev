...
const validationSchema = Yup.object({
  ...
  attendees: Yup.number().required('Number of attendees is required').positive().integer(),
  budget: Yup.string(),
  message: Yup.string(),
  consent: Yup.boolean().oneOf([true], 'You must agree to be contacted'),
});

export default function NewsletterCTACorporate() {
                        ...
                        <div className="form-grid">
                          ...
                          <div className="form-field">
                            ...
                            <Field
                              ...
                              id="eventType"
                              name="eventType"
                              placeholder="Conference, Incentive, etc."
                              disabled={isSubmitting}
                            />
                          ...
                          <div className="form-field">
                            ...
                            <Field
                              ...
                              disabled={isSubmitting}
                            />
                            <ErrorMessage name="attendees" component="div" className="field-error" />
                          </div>
                          <div className="form-field">
