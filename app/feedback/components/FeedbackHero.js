    ...
    <section className="section">
      <div className="padding-9rem">
        ...
        <div className="title-block">
          ...
          >
            Hear from our travelers about their unforgettable journeys and exceptional experiences with Toe Tripper.
          </motion.h5>
          ...
          >
            <p className="button-text">Share Your Story</p>
            <p className="button-text-absolute">Share Your Story</p>
