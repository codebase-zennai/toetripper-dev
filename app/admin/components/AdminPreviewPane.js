...
export default function AdminPreviewPane({ previewPackage }) {
  ...
  return (
    <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 border-dashed text-center text-gray-500 flex flex-col items-center justify-center min-h-75">
