      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-20">
        ...
        {activeTab === 'info' && (
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-linear-to-br from-amber-50 to-amber-100 rounded-lg">
              <div className="flex items-center gap-3 mb-4">
        ...
        {/* Bottom CTA */}
        <div className="mt-16 bg-linear-to-r from-orange-500 to-orange-600 rounded-lg p-8 md:p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white font-bold rounded-lg hover:bg-white/10 transition-colors duration-200"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-orange-600 font-bold rounded-lg hover:bg-gray-100 transition-colors duration-200"
            >
              Book Now
            </a>
          </div>
