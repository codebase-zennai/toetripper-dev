    ...
    <div className="">
      <div className="padding-9rem">
        ...
        <div className="title-block">
          ...
          <motion.h5 
            className="max-width-25rem"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3, delay: 0.15 }}
          >
            Travel Management That Works Like an Extension of Your Team
          </motion.h5>
      ...
      <div className="space-4rem hide-on-mobile"></div>
      <div className="space-7rem hide-on-tab"></div>
      <div className="space-7rem smaller-on-mobile"></div>
      <div className="space-7rem"></div>
      <div
        data-w-id="26f29636-e130-073f-81a3-5680a2a67ade"
        className="w-layout-blockcontainer services-container rounded-corners w-container"
      >
